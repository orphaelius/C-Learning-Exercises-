...
#define ELEMENTS 7 // Total options in instructions array
...
int main(void) {
	...
	while ((getSwitchKey = getKey(&getSwitchKey)) != 9) {
		...
		//printf("east %d, south %d, west %d, north %d\n", east, south, west, north);
	}

	//printf("The turtle is in position (%d, %d)\n", turtleX, turtleY);
